  ...
  party: [
    {
      ...
      lines: [
        ...
        "Access denied. You lack the key,\nand also the ticket.",
        "The migration is a gelatinous cube.\nIt absorbs whatever it touches.",
        "Legacy system. Armour class 22.\nNothing we own gets through.",
        "Someone cast Reorg.\nWe all lost a level.",
        "I rolled a 1 on Procurement.\nWe are buying it again next year.",
      ],
      name: "PERSEUS",
      role: "The Platform",
    ...
    },
    {
      ...
      lines: [
        ...
        "The onboarding doc was written\nby an adventurer who never returned.",
